...
!!! info "Estado del curso"
    La **parte I (capítulos 1 a 11) está completa**, con sus ejercicios, sus
    soluciones y sus ejemplos verificados. Las partes II y III, el capítulo 34 y
    el apéndice A están en preparación.

## Organización

- **Parte I — Introducción** (capítulos 1 a 11). Para quien no conoce Prolog.
...
- **Parte II — Prolog para programadores** (capítulos 12 a 23). Las técnicas de
  uso profesional cotidiano: estilo, control, rendimiento, todas las soluciones,
  orden superior, base de datos dinámica, texto, gramáticas, módulos, errores y
  pruebas.
- **Parte III — Lo avanzado** (capítulos 24 a 33). Inspección de términos,
  metaintérpretes, listas diferencia, compilación, archivos, interfaces,
  concurrencia, tabulación, restricciones y búsqueda.
- **Capítulo 34 — Prolog y SQL**. Para quien conoce SQL: las correspondencias
...
instalación local se requiere [SWI-Prolog](https://www.swi-prolog.org/) 9 o
posterior.
